<template>
  <div class="container mt-5">
    <form form class="border text-center p-5 col-6 mx-auto " @submit.prevent="onSubmit">
      ...
      <button type="submit" class="btn btn-secondary btn-block mb-4"  data-mdb-ripple-color="#20737e">Sign up</button>
